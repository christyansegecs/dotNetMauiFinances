...
public static class MauiProgram
{
	...
	public static MauiAppBuilder RegisterDatabaseAndRepositories(
		this MauiAppBuilder mauiAppBuilder)
	{
		mauiAppBuilder.Services.AddSingleton<LiteDatabase>(
			options =>
			{
				...
				return new LiteDatabase($"Filename={AppMauiFinances.AppSettings.DatabasePath};Connection=Shared");
			}
		);
